...
export function loadState() {
    try {
        ...
        // Update deviceId and exportedAt
...
export function exportDocument(state) {
    const doc = {
        ...state,
        exportedAt: new Date().toISOString(),
        deviceId: getDeviceId()
...
export function importDocument(jsonString, mergeStrategy = 'newest') {
    try {
...
// Get import preview
export function getImportPreview(jsonString) {
    try {
        const imported = JSON.parse(jsonString);
        validate(imported);
